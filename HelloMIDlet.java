...
public class HelloMIDlet extends MIDlet implements CommandListener{
    ...
    MineCanvas canvas;
    static final String openCommandString = "open";
    static final String clearCommandString = "clear";
    static final Command open =  new Command(openCommandString, Command.OK, 0);
    static final Command clear =  new Command(clearCommandString, Command.OK, 0);
...
//</editor-fold>//GEN-END:|18-getter|2|
    ...
    public void commandAction(Command cmd, Displayable dsplbl) {
        ...
        if (cmdLabel.equals(openCommandString))
            canvas.openSignal();    
        if (cmdLabel.equals(clearCommandString))
            canvas.clearSignal();
    }
